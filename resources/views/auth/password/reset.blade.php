...
<head>
    <title>Reset Password &mdash; Podcast</title>
    <meta charset="utf-8">
            ...
            <div class="container" data-aos="fade-up">
                <div class="row justify-content-center">
                    <div class="col-md-5 mb-5">
                        ...
                        <form action="{{ route('password.update') }}" method="post" class="bg-white">
                            @csrf
                            ...
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <label for="password-confirm" class="text-black">Confirm Password <span class="text-danger">*</span></label>
